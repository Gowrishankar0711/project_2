...
Analyze sales distribution across micro-markets

Understand buyer behavior and transaction patterns

Evaluate the impact of infrastructure and connectivity on pricing
...
Infrastructure vs Price Analysis

Geographic Sales Distribution (Map)

Page 2: Builder Drill-Through Details

Builder-level revenue KPI

Property-level details

Quarterly revenue contribution by builder
...
Revenue is evenly distributed across buyer types, channels, and micro-markets

Infrastructure quality is a baseline expectation, not a primary price driver

Balanced primary and secondary transactions reflect a mature resale market
...
Data Modeling & Interactive Filters
...
Buyer and transaction attributes

Location-based infrastructure and connectivity scores
